...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "<p>")).addTo(map); // Extend map bounce to include current location
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HKYHcIKTLi1QsBknQ0wkuR6I1PMPGVVOViG7PaTCPcGNLKT16ibSMvMhIeByW7ub7LyvM2Y8frgeGGOnry91Ptl00wTs87ZTH');
            _context.prev = 1;
            _context.next = 4;
